...
description:
  React performance optimization guidelines from Mastra Engineering. This skill
  should be used when writing, reviewing, or refactoring React code to ensure
...
Comprehensive performance optimization guide for React applications, containing
12 rules across 6 categories. Rules are prioritized by impact to guide automated
...
- `references/react-best-practices-reference.md` - Complete guide with all
  patterns
