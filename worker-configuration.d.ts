/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a190899bb4a0ba4cfc6afd6aa7f68b8)
// Runtime types generated with workerd@1.20260305.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		SESSION_SECRET: "";
		RESEND_API_KEY: "";
		FROM_EMAIL: "Seed Vault <onboarding@resend.dev>";
		RP_ID: "localhost";
		RP_NAME: "Seed Vault";
	...
	interface TestEnv {
		...
		RP_ID: "localhost";
		RP_NAME: "Seed Vault";
		RP_ORIGIN: "http://localhost:4200,http://localhost:4201,http://localhost:4202,http://localhost:4203,http://localhost:4204,http://localhost:4205,http://localhost:4206,http://localhost:4207";
		GOOGLE_CLIENT_ID: "";
		GOOGLE_CLIENT_SECRET: "";
		GITHUB_CLIENT_ID: "";
		GITHUB_CLIENT_SECRET: "";
	...
	interface Env {
		...
		RESEND_API_KEY: "" | "re_test_mock";
		FROM_EMAIL: "Seed Vault <onboarding@resend.dev>";
		RP_ID: "localhost" | "example.com";
		RP_NAME: "Seed Vault";
		RP_ORIGIN: "http://localhost:5173" | "http://localhost:4200,http://localhost:4201,http://localhost:4202,http://localhost:4203,http://localhost:4204,http://localhost:4205,http://localhost:4206,http://localhost:4207" | "https://example.com";
		GOOGLE_CLIENT_ID: "";
		GOOGLE_CLIENT_SECRET: "";
		GITHUB_CLIENT_ID: "";
		GITHUB_CLIENT_SECRET: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PLAUSIBLE_DOMAIN" | "PLAUSIBLE_HOST" | "SESSION_SECRET" | "RESEND_API_KEY" | "FROM_EMAIL" | "RP_ID" | "RP_NAME" | "RP_ORIGIN" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "SENTRY_DSN" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "DISABLE_RATE_LIMITING">> {}
}
