...
import { Logger, loggerContext } from '../app/utils/logger.server'
import { requestIdContext } from '../app/utils/request-id-context'
...
export default Sentry.withSentry<Env>(
	...
	}),
	{
		async fetch(request, env, ctx) {
			...
			// Tag Sentry events with the request ID
